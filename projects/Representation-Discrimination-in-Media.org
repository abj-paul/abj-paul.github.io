...
[8] shows an interesting approach. It first discoveres the news genre distributon of newspaper and then compares it with female population.
...
**** Result
Following is our result for CoRex Semi-Supervisd topic modeling on 4893 ethnic data.
...
*** Experiment - Nonethnic (100k) with Corex
** Survey
